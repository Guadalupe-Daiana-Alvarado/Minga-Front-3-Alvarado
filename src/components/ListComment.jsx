...
// import deleteComment from '../../redux/actions/deleteAction.js'
...
const Comment = ({ open, setOpen, chapter_id, chapterName }) => {
  ...
  const handleDeleteComment = (commentId) => {
    ...
    if (confirmed) {
      // Despachar la acción deleteComment con el commentId
  ...
  return (
    <div className='w-1/4 h-3/6 bg-white border border-pink-400 fixed right-0 bottom-0 flex flex-col items-center'>
...
// import 'react-toastify/dist/ReactToastify.css';
// import DeleteComment from "../components/DeleteComment"
// import EditComment from "../components/DeleteComment"
...
//     if (confirmed) {
//       // Lógica de eliminación del comentario
//       // Puedes llamar a la acción para eliminar el comentario aquí
//     }
//   };
