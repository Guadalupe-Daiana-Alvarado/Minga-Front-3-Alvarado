  ...
  return (
    <main className='flex flex-col w-full md:flex-row'>
        ...
        <div className=' h-3/4 flex flex-col justify-around items-center'>
          ...
          <Link to={"/author-form"}>
            <div className='w-96 md:w-3/4 flex border-solid border-2 rounded-md p-1 m-5'>
              <img src={imagen1} alt="" />
              <div>
                <h4 className='text-center text-pink-400 font-bold ml-5'>Join as an Author!</h4>
                <p className='text-center text-pink-300 font-semibold ml-5 mr-20'>I'm a reader writing a manga</p>
              </div>
            </div>
          </Link>

          <Link to={"/company-form"}>
            <div className='w-96 md:w-3/4 flex border-solid border-2 rounded-md p-1 m-5 cursor-pointer hover:active:true '>
              <img src={imagen2} alt="" />
              <div>
                <h4 className='text-center text-pink-400 font-bold ml-5'>Join as a Company!</h4>
                <p className='text-center text-pink-300 font-semibold ml-5'>I’m a company and I want to publish my comics</p>
              </div>
            </div>
          </Link>
      ...
      <div className='w-full md:w-1/2 md:m-5 min-h-screen bg-no-repeat bg-cover flex flex-col justify-start' style={{ backgroundImage: "url('./image/Rectangle.png')" }}>
        <div>
          <p className='p-5 m-10 text-center text-white font-bold'>Minga.com is the best place to find manga reviews. We’ve been super impressed by the quality of applicants.</p>
